 ...
 *   https://datatables.net/download/#dt/dt-2.1.8/af-2.7.0/b-3.1.2/cr-2.0.4/date-1.5.4
 *
 * Included libraries:
 *   DataTables 2.1.8, AutoFill 2.7.0, Buttons 3.1.2, ColReorder 2.0.4, DateTime 1.5.4
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.1.8/af-2.7.0/b-3.1.2/cr-2.0.4/date-1.5.4",
